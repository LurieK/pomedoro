...
function App() {
  ...
  }, [isActive, countDownTime, working, workDuration, breakDuration]);
  ...
  return (
    <div className="App">
      <Timer working={working} time={countDownTime} />
      <Buttons
        work={working}
        time={countDownTime}
        active={isActive}
      ...
      />
      <Goal />
      <Tracker working={working} active={isActive} />
      <Ding time={countDownTime} />
    </div>
  );
}
